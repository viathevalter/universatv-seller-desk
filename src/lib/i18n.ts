...
const translations: Record<string, Record<Language, string>> = {
  ...
  'admin.tab.apps': { pt: 'Gerenciar Apps', es: 'Gestionar Apps' },
  'admin.tab.users': { pt: 'Gerenciar Usuários', es: 'Gestionar Usuarios' },
  'admin.users.title': { pt: 'Usuários do Sistema', es: 'Usuarios del Sistema' },
  'admin.users.add': { pt: 'Novo Usuário', es: 'Nuevo Usuario' },
  'admin.users.newTitle': { pt: 'Cadastrar Novo Vendedor', es: 'Registrar Nuevo Vendedor' },
  'admin.users.name': { pt: 'Nome Completo', es: 'Nombre Completo' },
  'admin.users.email': { pt: 'Email de Acesso', es: 'Email de Acceso' },
  'admin.users.role': { pt: 'Nível de Acesso', es: 'Nivel de Acceso' },
  'admin.users.sendInvite': { pt: 'Salvar Usuário', es: 'Guardar Usuario' },
  'admin.users.search': { pt: 'Buscar por nome...', es: 'Buscar por nombre...' },
  'admin.users.colName': { pt: 'Usuário', es: 'Usuario' },
  'admin.users.colRole': { pt: 'Cargo', es: 'Cargo' },
  'admin.users.colDate': { pt: 'Cadastro', es: 'Registro' },
  'admin.users.colActions': { pt: 'Ações', es: 'Acciones' },
  'admin.users.empty': { pt: 'Nenhum usuário encontrado.', es: 'Ningún usuario encontrado.' },
  'admin.users.createSuccess': { pt: 'Usuário cadastrado com sucesso!', es: '¡Usuario registrado con éxito!' },
